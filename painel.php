...
<body>
    ...
    <form method="post">
        ...
        <?php //Banco de dados 
            ...
            // CRUD
            // Insert
            if (isset($_POST['nome']) && isset($_POST['mensagem']) && !isset($_POST['id'])) {
            ...
            // Update
            if (isset($_POST['id']) && isset($_POST['nome']) && isset($_POST['mensagem'])) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                ...
                                <a href='?delete_id=" . $row['id'] . "' onclick='return confirm(\"Tem certeza que deseja deletar este registro?\")'>Deletar</a>
                            </td>
                        </tr>";
                }
                echo "</table>";
